  ...
  return (
    <section className="coming-fade-up w-full text-center">
      <div className="space-y-2">
        <p className="text-4xl font-black tracking-wide text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.08)] sm:text-5xl md:text-6xl">
          L4ckos
        </p>
        <p className="text-[11px] tracking-[0.38em] text-zinc-300 sm:text-xs md:text-sm">LOJA ESCOTEIRA</p>
      </div>

      <h1 className="mx-auto mt-7 max-w-4xl text-balance text-3xl font-black uppercase leading-[1.04] text-white sm:text-4xl md:mt-8 md:text-6xl">
