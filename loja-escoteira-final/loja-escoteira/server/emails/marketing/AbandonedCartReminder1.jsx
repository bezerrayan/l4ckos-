...
export function AbandonedCartReminder1({ name, cartUrl, products = [] }) {
  return (
    <EmailLayout preview="Seu carrinho ainda esta te esperando" title="Seu carrinho ficou para tras" subtitle="Os itens continuam reservados por pouco tempo">
