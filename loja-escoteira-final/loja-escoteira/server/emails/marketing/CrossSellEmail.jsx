...
export function CrossSellEmail({ name, collectionUrl, products = [] }) {
  return (
    <EmailLayout preview="Complete seu setup L4CKOS" title="Itens que combinam com sua compra" subtitle="Curadoria complementar">
